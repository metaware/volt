if RUBY_PLATFORM != 'opal'
  ...
  describe AssetFiles do
    ...
    it "should list all JS files" do
      ...
      expect(main.javascript_files(nil)).to eq(["/assets/js/bit_vector.js", "/assets/js/jquery-2.0.3.js", "/assets/js/murmurhash3_gc.js", "/assets/js/sockjs-0.3.4.min.js", "/assets/js/vertxbus.js", "/assets/js/bootstrap.js", "/assets/js/test2.js", "/assets/js/test3.js", "/assets/js/test1.js", "/assets/volt/page/page.js", "/components/main.js"])
    end
  end
end
